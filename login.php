...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="http://signin.66km.com/assets/css/register.css" rel="stylesheet">
    <title>自点科技-登录</title>
</head>

<body class="page-login" style="height: 100%; zoom: 1; background: url(http://signin.66km.com/assets/img/login_bj.jpg) 50% 0% no-repeat;">
    <?php echo md5("123456") ?>
    <div id="login">
    	<div class="login-con">
